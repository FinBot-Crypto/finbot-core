...
import LemeSettings from './pages/LemeSettings';
      ...
      <div className="flex min-h-screen bg-dark">
        ...
        <nav className={`w-64 bg-slate-900 border-r border-slate-800 p-6 flex flex-col justify-between fixed md:sticky md:top-0 h-screen z-10 transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}>
          <div>
            ...
            <ul className="space-y-1 mt-12 md:mt-0">
              ...
              <li className="pt-4 pb-1 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Estratégias</li>
              <li>
                <Link to="/strategies/leme" onClick={closeSidebar} className="text-slate-300 hover:text-white hover:bg-slate-800 px-4 py-3 rounded-lg block transition-colors flex items-center gap-3">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
                  Leme
                </Link>
              </li>
              <li>
                <Link to="/strategies/mare" onClick={closeSidebar} className="text-slate-300 hover:text-white hover:bg-slate-800 px-4 py-3 rounded-lg block transition-colors flex items-center gap-3">
                  🌊 Maré
                </Link>
              </li>
            </ul>
        ...
        <main className="flex-1 overflow-y-auto mt-16 md:mt-0 p-4 md:p-6">
          <Routes>
            ...
            <Route path="/strategies/leme" element={<LemeSettings />} />
            <Route path="/strategies/mare" element={<Mare />} />
          </Routes>
        </main>
      </div>
    </Router>
